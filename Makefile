...
EXEC = ${DOCKER} exec -w /var/www/project www_bookproject
PHP = ${EXEC} php
...
consoleApp: ## Accéder à la console de l'application
	$(DOCKER) exec -it www_bookproject sh
...
database-update: ## Mise à jour de la base de données / Update database
